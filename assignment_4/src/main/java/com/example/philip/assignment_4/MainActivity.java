...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fraAct.replace(R.id.start_layout, gf);
        fraAct.commit();
    }
...
//            df.show(fm, "dialog");
            ...
            dialogueFragment.show(fragmentTransaction, "tag");

            //getSupportFragmentManager().beginTransaction().show(new DialogueFragment());
